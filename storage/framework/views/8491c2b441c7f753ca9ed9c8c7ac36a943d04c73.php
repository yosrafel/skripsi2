			...
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span><?php echo e(auth()->user()->nama); ?></span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="/admin/list_kelas" class="<?php echo $__env->yieldContent('kelas'); ?>"><i class="lnr lnr-code"></i> <span>Kelas</span></a></li>
...
<?php /**PATH D:\Rafel\coding\skripsi2\resources\views/layout/master.blade.php ENDPATH**/ ?>