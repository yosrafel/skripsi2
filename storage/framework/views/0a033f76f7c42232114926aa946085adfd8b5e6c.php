...
<div class="panel panel-headline">
  ...
  <div class="container">
    <div class="col-md-11">
      <form action="/kaprodi/<?php echo e($pekerjaan->id); ?>/update_pekerjaan" method="POST">
        ...
        <div class="form-group mb-5">
            <a type="button" class="btn btn-danger" href="/kaprodi/profil"> Kembali </a>
...
<?php echo $__env->make('layout/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Rafel\coding\skripsi2\resources\views/kaprodi/dtl_pekerjaan.blade.php ENDPATH**/ ?>