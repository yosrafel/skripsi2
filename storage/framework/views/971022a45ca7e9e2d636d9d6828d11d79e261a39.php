  ...
  <div class="panel-body">
    <div style="overflow-x:auto;">
      <table class="table" id="dtBasicExamples">
        ...
        <tbody>
        <?php $sumBkd = 0;?>
          <?php $__currentLoopData = $kelas->sortBy('dosen_id')->sortBy('kelas_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php $sumBkd += $kelas->kelas->bkd();?>
              ...
              <td><?php echo e($kelas->bkd_inqa); ?></td>
              </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Rafel\coding\skripsi2\resources\views/inqa/index.blade.php ENDPATH**/ ?>